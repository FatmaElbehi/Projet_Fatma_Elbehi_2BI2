...
namespace Projet_Fatma_Elbehi_2BI2.Controllers
{
    public class ProduitsController : Controller
    {
        ...
        public ProduitsController(Projet_Fatma_Elbehi_2BI2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ProduitNom,ProduitDescription,CategorieId")] Produits produits)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProduitNom,ProduitDescription,CategorieId")] Produits produits)
        {
            if (id != produits.Id)
            {
                return NotFound();
